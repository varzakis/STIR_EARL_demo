...
!name of data file := nema_lu177_sca_w1.a00
;patient name := SMC_nema_lu177_sca_w1.a00
;!study ID := nema_lu177
...
energy window lower level[1] := 101.70
energy window upper level[1] := 124.30
...
maximum pixel count := 36.087612
;# total counts := 16351.785486
