...
name of data file := nema_lu177_tot_w5_noise.s
;patient name := SMC_nema_lu177_tot_w5.a00
;!study ID := nema_lu177
...
energy window lower level[1] := 67.50
energy window upper level[1] := 82.50
...
maximum pixel count := 22.536503
;# total counts := 9183.695339
